...
export default defineManifest(async (env) => ({
  name:
    env.mode === 'staging'
      ? '[INTERNAL] Plugin'
      : 'Plugin - Power of ChatGPT on any website',
  description:
    "Plugin is a browser extension that allows you to use Open AI's GPT in any website.",
  version: `${major}.${minor}.${patch}.${label}`,
  version_name: version,
  action: {
    default_title: 'Plugin - Open Sidebar',
  },
  commands: {
    'open-sidebar': {
      suggested_key: {
